  ...
  },
  {
    ...
    content: `
      ...
      <ul class="icon-list blue-bullets" style="margin-top: 1.5rem;">
        ...
        <li><strong>El Salto Cuántico Existencial (Herramienta 6):</strong> Define un futuro imposible sin garantías. Da un paso HOY sabiendo que podrías fracasar. Aprende a vivir con la incertidumbre, ese es el "Caballero de la Fe" de Kierkegaard.</li>
      </ul>
